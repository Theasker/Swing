...
public class FormHolaMundo extends javax.swing.JFrame {
  ...
  private void initComponents() {
    ...
    jLabel1.setText("Hola Java Utilizando Formulario");
  ...
  public static void main(String args[]) {
    ...
    try {
      ...
      java.util.logging.Logger.getLogger(FormHolaMundo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
